"""
功能概述
`wqb_core.alpha.get_alpha_details` 模块。
...
class GetAlphaDetailsMixin:
    def get_alpha_details(
        ...
        **kwargs,
        ...
        该方法通过 `WQBSession.get_alpha_details(...)` 暴露。
        """
        return self.locate_alpha(alpha_id, *args, log=log, **kwargs)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description=inspect.getdoc(GetAlphaDetailsMixin.get_alpha_details) or "")
    ...
    target = getattr(session, "get_alpha_details")
