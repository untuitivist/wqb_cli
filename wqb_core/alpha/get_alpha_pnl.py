"""
功能概述
`wqb_core.alpha.get_alpha_pnl` 模块。
...
class GetAlphaPnlMixin:
    def get_alpha_pnl(
        ...
        **kwargs,
        ...
        该方法通过 `WQBSession.get_alpha_pnl(...)` 暴露。
        """
        return self.get_pnl(alpha_id, *args, **kwargs)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description=inspect.getdoc(GetAlphaPnlMixin.get_alpha_pnl) or "")
    ...
    target = getattr(session, "get_alpha_pnl")
