"""
功能概述
`wqb_core.alpha.get_performance_comparison` 模块。
...
class GetPerformanceComparisonMixin:
    def get_performance_comparison(
        ...
        **kwargs,
        ...
        """
        获取 performance comparison 原始结果。
        
        该方法通过 `WQBSession.get_performance_comparison(...)` 暴露。
        """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description=inspect.getdoc(GetPerformanceComparisonMixin.get_performance_comparison) or "")
    ...
    target = getattr(session, "get_performance_comparison")
