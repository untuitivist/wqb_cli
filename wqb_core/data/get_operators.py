"""
功能概述
`wqb_core.data.get_operators` 模块。
...
class GetOperatorsMixin:
    def get_operators(
        ...
        **kwargs,
        ...
        该方法通过 `WQBSession.get_operators(...)` 暴露。
        """
        return self.search_operators(*args, log=log, **kwargs)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description=inspect.getdoc(GetOperatorsMixin.get_operators) or "")
    ...
    target = getattr(session, "get_operators")
