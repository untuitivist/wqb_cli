"""
功能概述
`wqb_core.data.search_fields` 模块。
...
class SearchFieldsMixin:
    def search_fields(
        ...
        **kwargs,
        ...
        该方法通过 `WQBSession.search_fields(...)` 暴露。
        """
        if log is None:
            log_gap = 0
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description=inspect.getdoc(SearchFieldsMixin.search_fields) or "")
    ...
    target = getattr(session, "search_fields")
