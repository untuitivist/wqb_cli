...
from ..foundation.defines import GET
from ..foundation.urls import URL_ALPHAS_ALPHAID_CHECK
...
class CheckMixin:
    async def check(
        ...
        **kwargs,
        ...
        """
        轮询单个 Alpha 的 check 结果。
        
        该方法通过 `WQBSession.check(...)` 暴露。
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description=inspect.getdoc(CheckMixin.check) or "")
